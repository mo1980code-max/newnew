...
- فهرس السور الـ114؛
- وضع **المصحف بالصفحات** للتنقل بين تقسيم المصحف المدني إلى 604 صفحات، مع السابق/التالي
  والانتقال المباشر إلى صفحة أو أحد الأجزاء الثلاثين؛
- بحثًا في اسم السورة أو نص الآيات (ويقبل مرجعًا مثل `2:255`)؛
- حفظ أول آية مرئية لاستئناف القراءة، وربط الموضع بالصفحة المعيارية؛
- علامات محفوظة لكل آية يمكن فتحها أو حذفها من شاشة **العلامات**؛
- تغيير حجم نص الآيات وحفظ الاختيار محليًا في وضعي السورة والمصحف.
